...
(function() {
  var template = Handlebars.template, templates = Handlebars.templates = Handlebars.templates || {};
templates['neo4j_query'] = template(function (Handlebars,depth0,helpers,partials,data) {
  this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Handlebars.helpers); data = data || {};
...
(function() {
  var ContentTypeView, HeaderView, MainView, Neo4jView, OperationView, ParameterContentTypeView, ParameterView, ResourceView, ResponseContentTypeView, SignatureView, StatusCodeView, SwaggerUi,
  ...
  Neo4jView = (function(_super) {

    __extends(Neo4jView, _super);

    function Neo4jView() {
      Neo4jView.__super__.constructor.apply(this, arguments);
    }
